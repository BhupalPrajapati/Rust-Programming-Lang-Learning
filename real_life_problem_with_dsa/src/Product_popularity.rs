...
fn popularity_analysis(scores:Vec<i32>) ->bool{    // ouput od this function is bool, bcz popularity is in true or false(increasing or decreasing)
let mut increasing = true;
let mut decreasing = true;
for i in 0..scores.len()-1{    // interating through the certain product 
